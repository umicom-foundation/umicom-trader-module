...
/*
 * Provide the trader productisation contribution operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the trader productisation snapshot operation used by this module and its client
 * applications.
 */
